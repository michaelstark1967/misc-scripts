...
```csv
environment,connector_id,rx_bytes,rx_display,tx_bytes,tx_display,total_bytes,total_display,percent_of_budget
DEV,33168,123456789012,115.00 GB,987654321098,920.00 GB,1037.00 GB,1037.00 GB,0.16
QA,36205,234567890123,218.50 GB,345678901234,321.75 GB,540.25 GB,540.25 GB,0.08
QA2,36542,345678901234,322.00 GB,123456789012,115.00 GB,437.00 GB,437.00 GB,0.07
PROD,36608,456789012345,425.50 GB,234567890123,217.75 GB,643.25 GB,643.25 GB,0.10

TOTAL_RX_BYTES,1166043582714
TOTAL_RX_DISPLAY,1.06 TB
TOTAL_TX_BYTES,1693459902467
TOTAL_TX_DISPLAY,1.54 TB
TOTAL_USED_BYTES,2669503485181
TOTAL_USED_DISPLAY,2.40 TB
BUDGET_TOTAL_TB,650
BUDGET_TOTAL_BYTES,7136238463523072
BUDGET_REMAINING_BYTES,71335689600378891
BUDGET_REMAINING_DISPLAY,649.99 TB remaining
BUDGET_PERCENT_LEFT,99.85
```
